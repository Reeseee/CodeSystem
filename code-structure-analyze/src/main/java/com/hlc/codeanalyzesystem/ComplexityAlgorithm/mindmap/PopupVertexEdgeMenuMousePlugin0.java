 ...
 */
public class PopupVertexEdgeMenuMousePlugin0<V, E> extends AbstractPopupGraphMousePlugin {
    private JPopupMenu edgePopup, vertexPopup;
    
    /** Creates a new instance of PopupVertexEdgeMenuMousePlugin */
    public PopupVertexEdgeMenuMousePlugin0() {
     ...
     */
    public PopupVertexEdgeMenuMousePlugin0(int modifiers) {
        super(modifiers);
    }
