...
public class classNode {
	...
	public classNode(String title, String brief, Vector<String> keywords) {
		this.id = _id++;
		this.title = title;
		this.brief = brief;
		if (keywords == null)
...
class classNodeFactory implements Factory<classNode> {
	static IdeaFactory instance = new IdeaFactory();

	public classNode create() {
		return new classNode("", "", new Vector<String>());
	}
